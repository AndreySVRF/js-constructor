...
var Block = /*#__PURE__*/function () {
  ...
  _createClass(Block, [{
    ...
    value: function toHTML() {
      throw new Error('Метод toHTML не был реализован');
    }
  }]);
...
var Sidebar = /*#__PURE__*/function () {
  function Sidebar(selector, updateModel) {
  ...
  _createClass(Sidebar, [{
    ...
    key: "template",
    get: function get() {
      return [(0, _utils.block)('title', 'Заголовок'), (0, _utils.block)('text', 'Текстовое поле')].join('');
    }
  }]);
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var updateModel = function updateModel(newBlock) {
...
var model = [new _blocks.TitleBlock('Контрустор сайтов на чистом JavaScript', {
  tag: 'h2',
  styles: {
...
}), new _blocks.TextBlock('Welcome to my first app on JavaScript', {
  styles: {
    background: 'linear-gradient(to right, #f2994a, #f2c94c)',
    padding: '1rem',
    'font-weight': 'bold'
  }
}), new _blocks.ColumnsBlock(['Приложение на чистом JavaScript без использования фреймворков', 'Узнаешь как работают принципы JavaScript за один курс', 'JavaScript самый крутой язык программирования'], {
  styles: {
...
exports.model = model;
},{"./classes/blocks":"classes/blocks.js","./assets/image.png":"assets/image.png"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
